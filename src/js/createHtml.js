export function createHtml(movies) {
    ...
    for (let i = 0; i < movies.length; i++) {
      ...
      closeBtnImg.setAttribute("src", "https://github.com/StyleSensei/movies/blob/main/src/media/close-svgrepo-com.svg");
      closeBtnImg.classList.add("closeBtnImg");
      closeBtn.classList.add("closeBtn");
      playBtnImg.setAttribute(
        "src",
        "https://github.com/StyleSensei/movies/blob/main/src/media/play_circle_FILL0_wght400_GRAD0_opsz24.svg"
      );
